...
#include <stdlib.h>
/*
 * The bugs is the different data types between sending data (alpha) and receiving data (beta).
 * To fix: make the data type of alpha and beta to be the same, then change the format of printing data
 */
