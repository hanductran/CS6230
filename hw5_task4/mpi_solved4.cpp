...
/*
 * As shown in the Hint, the bug is the MASTER process does not have MPI_Reduce.
 * To fix: include MPI_Reduce in the MASTER, then the correct final sum will be double the initial sum
 */
